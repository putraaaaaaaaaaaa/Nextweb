  ...
  return (
    <div className="container">
      ...
      >
        ...
        >
          <Link
            className="flex items-center gap-x-2 rounded-[--card-radius] bg-muted duration-300 ease-in-out hover:shadow-2xl hover:ring-2 hover:ring-primary hover:ring-offset-2 hover:ring-offset-background md:gap-x-3 bg-title-product"
            href="/mobile-legends"
          >
            <div className="flex items-center gap-3 p-[--card-padding]">
              ...
              <h2 className="w-[100px] truncate text-xxs font-semibold text-foreground sm:w-[125px] md:w-[150px] md:text-base lg:w-[175px]">Mobile Legends</h2>
